...
def obtenerModelo():
  ...
  #Construcción de arquitectura neuronal
  modelo.add(Dense(1, input_shape=(11, )))
...
def obtenerArgumentos():
    ...
    #Parseamos el ratio de aprendizaje
    parseadorDeParametros.add_argument("--learning-rate", type = float, default = 0.001)

    #Parseamos el tamaño de batch
    parseadorDeParametros.add_argument("--batch-size", type = int, default = 32)

    #Parseamos la función de activación
    #parseadorDeParametros.add_argument("--activation-function", type = str, default = "relu")
    ...
    return parametros.train, parametros.learning_rate, parametros.batch_size
...
if __name__ == '__main__':
    ...
    rutaDeDatos, learning_rate, batch_size = obtenerArgumentos()
    ...
    modelo.compile(Adam(learning_rate = learning_rate), "mean_squared_error")

    #Entrenamos el modelo
    modelo.fit(x_train, y_train, validation_data = (x_test, y_test), epochs = 100, batch_size = batch_size)
