...
def obtenerModelo(funcionDeActivacion):
    #Instanciamos una arquitectura de red neuronal
    modelo = Sequential()
    
    #Capa 1
    modelo.add(Dense(64, input_shape=(11, ), activation = funcionDeActivacion))
    
    #Capa 2
    modelo.add(Dense(64, activation = funcionDeActivacion))

    #Capa 3
    modelo.add(Dense(16, activation = funcionDeActivacion))

    #Capa 4
    modelo.add(Dense(32, activation = funcionDeActivacion))
...
def obtenerArgumentos():
    ...
    parseadorDeParametros.add_argument("--funcion-activacion", type = str, default = "relu")
    ...
    return parametros.train, parametros.funcion_activacion
...
if __name__ == '__main__':
    ...
    rutaDeDatos, funcion_activacion = obtenerArgumentos()

    #Obtenemos la arquitectura del modelo
    modelo = obtenerModelo(funcion_activacion)
